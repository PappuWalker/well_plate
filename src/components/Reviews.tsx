...
const Reviews = () => {
  const reviews: Review[] = [
    { id: 1, author: 'Sara Patel', text: 'Wellplate made it so easy to find kidney-friendly meals. The taste and variety are amazing!', rating: 5, role: 'Nutritionist, Kidney Health Advocate' },
    { id: 2, author: 'David Kim', text: 'Fast delivery and the diabetes meal plan helped me manage my sugar levels. Love the fresh ingredients!', rating: 5, role: 'Customer, Type 2 Diabetes' },
    { id: 3, author: 'Emily Chen', text: 'The heart-healthy foods are delicious and give me peace of mind. Highly recommend Wellplate!', rating: 4, role: 'Cardiac Wellness Coach' },
  ];

  return (
    <section className="bg-gradient-to-b from-[#10151B] via-[#151E26] to-[#10151B] py-16 sm:py-24">
                  ...
                  <div className="flex items-center gap-1">
                    {[...Array(5)].map((_, i) => (
                      <svg
                        ...
                        fill="currentColor"
                        viewBox="0 0 24 24"
                        className={`h-5 w-5 ${i < review.rating ? 'text-amber-400' : 'text-slate-600'}`}
                      >
...
<span className="block ml-2 text-slate-400 text-xs font-medium mt-0.5">{review.role}</span>
                  ...
                  <div className="mt-6 flex items-center gap-4">
                    <div className="group/avatar relative">
                      ...
                      <div className="relative h-12 w-12 rounded-full bg-slate-950 ring-2 ring-slate-950 flex items-center justify-center">
                        <svg fill="currentColor" viewBox="0 0 24 24" className="h-8 w-8 text-indigo-500">
                  ...
                  <div className="mt-6 grid grid-cols-3 gap-4">
                    <div className="rounded-xl bg-slate-900/50 p-4">
                      <div className="flex items-center gap-2">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-5 w-5 text-indigo-500">
                          <path d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
                        </svg>
                    ...
                    <div className="rounded-xl bg-slate-900/50 p-4">
                      <div className="flex items-center gap-2">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-5 w-5 text-indigo-500">
                          <path d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
                        </svg>
                    ...
                    <div className="rounded-xl bg-slate-900/50 p-4">
                      <div className="flex items-center gap-2">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-5 w-5 text-indigo-500">
                          <path d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.095c-.5 0-.905.405-.905.905 0 .714-.211 1.412-.608 2.006L7 11v9m7-10h-2M7 20H5a2 2 0 01-2-2v-6a2 2 0 012-2h2.5" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
                        </svg>
                  ...
                  <div className="mt-6 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="rounded-lg bg-slate-900 p-2 text-slate-400 transition-colors hover:text-white">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-5 w-5">
                          <path d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
                        </svg>
                      </button>
                      <button className="rounded-lg bg-slate-900 p-2 text-slate-400 transition-colors hover:text-white">
                        <svg stroke="currentColor" viewBox="0 0 24 24" fill="none" className="h-5 w-5">
                          <path d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" strokeWidth="2" strokeLinejoin="round" strokeLinecap="round"></path>
                        </svg>
                      </button>
                    </div>
