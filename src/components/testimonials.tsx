...
const testimonials = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?q=80&w=300",
    name: "Aliza Khan",
    role: "Business Analyst",
  },
  {
    text: "Our business functions improved with a user-friendly design and positive customer feedback.",
    image: "https://images.unsplash.com/photo-1547425260-f2b08422138a?q=80&w=300",
    name: "Farhan Siddiqui",
    role: "Marketing Director",
  },
  {
    text: "They delivered a solution that exceeded expectations, understanding our needs and enhancing our operations.",
    image: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=300",
    name: "Sana Sheikh",
    role: "Sales Manager",
  },
  {
    text: "Using this ERP, our online presence and conversions significantly improved, boosting business performance.",
    image: "https://images.unsplash.com/photo-1500048993953-d23a436266cf?q=80&w=300",
    name: "Hassan Ali",
      ...
      <div className="container z-10 mx-auto px-4">
        ...
        >
          <div className="flex justify-center">
            <div className="border border-primary/20 py-1 px-4 rounded-lg text-primary">
              Testimonials
            </div>
          </div>
          ...
          <p className="text-center mt-5 opacity-75 max-w-md">
